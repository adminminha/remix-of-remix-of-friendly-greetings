// Base configuration files as string constants for Tota AI user projects
// These will be copied to new projects during initialization

export const BASE_PACKAGE_JSON = `{
  "name": "tota-ai-project",
  "private": true,
  "version": "1.0.0",
  "type": "module",
  "scripts": {
...
export const BASE_TAILWIND_CONFIG = `import type { Config } from 'tailwindcss';
...
export const BASE_APP_TSX = `function App() {
  return (
...
export const BASE_UTILS_TS = `import { type ClassValue, clsx } from 'clsx';
...
export const BASE_POSTCSS_CONFIG = `export default {
  plugins: {
    tailwindcss: {},
    autoprefixer: {},
  },
...
export const BASE_COMPONENTS_JSON = `{
